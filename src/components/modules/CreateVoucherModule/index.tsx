"use client"
import { createVoucher } from "@/api/service";
import { useRouter } from "next/navigation";
import { useState } from "react";

const CreateVoucherModule = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      return (
        <div className="flex flex-col items-center justify-center w-full min-h-screen bg-gray-200 p-8">
          <h1 className="text-2xl font-bold mb-4 text-black">Create Voucher</h1>
...
export default CreateVoucherModule